 ...
 *******************************************************************************/
package cat.gencat.canigo.repository.impl;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.context.annotation.Lazy;
import org.springframework.data.jpa.repository.support.QueryDslRepositorySupport;

import cat.gencat.canigo.model.Equipament;
import cat.gencat.canigo.repository.EquipamentRepository;
import cat.gencat.canigo.repository.EquipamentRepositoryCustom;

public class EquipamentRepositoryImpl extends QueryDslRepositorySupport implements EquipamentRepositoryCustom {

	@Autowired
	@Lazy
	private EquipamentRepository equipamentRepository;

	public EquipamentRepositoryImpl() {
		super(Equipament.class);
	}
